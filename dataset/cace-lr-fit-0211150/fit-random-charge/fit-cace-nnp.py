...
task.save_model('pointcharge-model.pth')
cace_nnp.to(device)
...
task.save_model('pointcharge-model-2.pth')
cace_nnp.to(device)
...
task.save_model('pointcharge-model-3.pth')
...
task.save_model('pointcharge-model-4.pth')
