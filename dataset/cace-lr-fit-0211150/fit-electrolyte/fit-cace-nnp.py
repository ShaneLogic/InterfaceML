...
collection = cace.tasks.get_dataset_from_xyz(train_path='electrolyte.xyz',
...
task.save_model('electrolyte-model.pth')
cace_nnp.to(device)
...
task.save_model('electrolyte-model-2.pth')
cace_nnp.to(device)
...
task.save_model('electrolyte-model-3.pth')
