...
collection = cace.tasks.get_dataset_from_xyz(train_path='../Pt-electro/train.xyz',
                                 valid_fraction=0.1,
                                 seed=1,
                                 cutoff=cutoff,
                                 data_key={'energy': 'energy', 'forces':'forces'}, 
                                 atomic_energies={1: -187.61682816337733, 8: -93.80841408168897, 9: -715.5623331985565, 19: -715.562333198551, 78: -714.7129333135166} # avg
                                 )
batch_size = 4
...
task.save_model('pt-KF-water-model.pth')
cace_nnp.to(device)
...
task.save_model('pt-KF-water-model-2.pth')
cace_nnp.to(device)
...
task.save_model('pt-KF-water-model-3.pth')
...
task.save_model('pt-KF-water-model-4.pth')
