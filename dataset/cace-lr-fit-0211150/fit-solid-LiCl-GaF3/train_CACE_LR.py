...
args_dict = {'zs': None, 
        ...
        "lr_n_hidden": [24, 12],
        "lr_n_layers": 3,
        "lr_n_out": 1, # n > 1 for multi-channel q
        }
...
forces = Forces(calc_forces = True, calc_stress = False, # True, 
...
cace_nnp_sr = NeuralNetworkPotential(representation=cace_representation, 
                                  input_modules=[preprocessor], 
                                  output_modules=[atomwise, forces]).to(device)
